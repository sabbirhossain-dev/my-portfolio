...
const All = () => {
  return (
    <>
        ...
        <Card image={forever} title='E-commarce Website' liveLink='https://clothing-website-azure.vercel.app' codeLink='https://github.com/sabbirhossain-dev/clothing-website.git' className="h-full"/>
