        ...
        <div className="">
          ...
          >
            <img
              src={sabbir}
              alt="logo"
              className="w-[80px] lg:w-32 h-auto cursor-pointer"
            />
          </Link>
        </div>
        ...
        <div className="">
          <ul className="hidden md:flex gap-10">
            {navData.map(({ id, link, title }) => (
              <li
                key={id}
                className=" text-base text-gray-400 tracking-wider cursor-pointer hover:text-designColor transition-colors duration-300"
              >
                <Link
                  activeClass="active"
                  to={link}
